...
<script>
    export default {
        ...
        created () {
            ...
            this.$getDataFromServerOrCache('/wp-json/wp/v2/pages/'+this.routeId+'?fields=id,title,acf','pageData','pageData'+this.routeId,this.contentUpdated,'pageDataLoaded',false,null,afterGetFunc);
